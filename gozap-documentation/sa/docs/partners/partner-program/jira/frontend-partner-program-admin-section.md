...
2. Администратор может искать и фильтровать список партнёров.
3. Администратор может привязать/отвязать станции к партнёру и задать процент по каждой.
4. Администратор может открыть представление, идентичное кабинету партнёра, для любого партнёра.
