...
- форма создания партнёра (логин, пароль, имя, телефон, процент вознаграждения)
- форма редактирования данных уже созданного партнёра (логин, имя, телефон, процент вознаграждения)
...
- интерфейс привязки/отвязки станций к партнёру; процент вознаграждения задаётся один раз для партнёра (включая 0%) и применяется к прибыли со всех его станций
...
1. Администратор может создать партнёра с логином, паролем, именем, телефоном и процентом вознаграждения.
...
4. Администратор может привязать/отвязать станции к партнёру; процент вознаграждения партнёра применяется к прибыли со всех его станций.
