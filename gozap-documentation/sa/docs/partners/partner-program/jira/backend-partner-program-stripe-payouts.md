...
- constraints: точный Stripe-продукт для выплат не подтверждён продуктом; поведение при отсутствии указанного счёта/карты к моменту выплаты не определено
...
5. Партнёр может выгрузить CSV по заработку и выплатам за выбранный период.
...
- Поведение при отсутствии счёта/карты на момент плановой выплаты не определено.
