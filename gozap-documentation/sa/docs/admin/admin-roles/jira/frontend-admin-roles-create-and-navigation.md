...
В `gozap-admin` отсутствует форма создания администратора с множественным выбором разделов и условная навигация, скрывающая неназначенные разделы.
...
3. Администратор видит в навигации только разделы, входящие в его назначенный набор; пункты меню недоступных разделов полностью отсутствуют в боковом меню (не отображаются заблокированными).
